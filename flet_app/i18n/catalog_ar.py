...
STRINGS = {
    ...
    "res.reserve": "حجز",
    "res.transfer": "نقل",
    "form.hint.id": "رقم الهوية الوطنية (10 أرقام)",
    "form.hint.cr": "رقم السجل التجاري (10 أرقام)",
    "form.segment": "شريحة العميل",
    "form.segment.retail": "أفراد (شخص طبيعي)",
    "form.segment.corporate": "شركات",
    "res.release_selected": "إرجاع الأرقام المحددة",
    "res.release_hint": "أعِد الأرقام التي لن تستخدمها ليُعاد إصدارها لاحقاً.",
    "res.release": "إرجاع",
...
""",
    ...
    "retro.get_template": "تنزيل القالب",
    "retro.upload": "رفع الملف المعبّأ",
    "retro.save_template": "حفظ القالب الفارغ",
    "retro.choose_file": "اختر الملف المعبّأ",
    "retro.template_written": "حُفظ القالب في {path}. عبّئه ثم ارفعه هنا.",
    "retro.working": "جارٍ فحص {name}...",
    "retro.imported": "تم استيراد {n} تقرير تاريخي من {name}.",
    "retro.imported_short": "تم استيراد {n} تقرير تاريخي",
    "retro.batch": "دفعة الاستيراد {id}",
    "retro.refused": "رُفض الملف. لم يتم استيراد أي شيء.",
    "retro.problems_heading": "كل الأخطاء التي وُجدت، مجمّعة حسب النوع:",
    "retro.example_rows": "الصفوف: {rows}",
    "retro.err.unavailable": "استيراد البيانات التاريخية غير متاح في هذه الجلسة.",
    "admin.import_history": "استيراد السجل التاريخي",
    ...
    "hostbanner.stuck": "{n} إدخال ما زال بانتظار المزامنة — سجّل الخروج ثم الدخول مجدداً لإرسالها.",
